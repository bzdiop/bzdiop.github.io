...
<summary>Abstract</summary> 
  ...
  <font size="-0.5">
I explore the impacts of agricultural input subsidies programs (ISPs) in an environment where farmers face binding credit constraints and lack knowledge about the efficient use of fertilizers. In this context, ISPs not only affect  farming practices but also shape household decisions in relation to migration. I construct a theoretical framework to illustrate the links between subsidies and migration. The subsidy addresses two challenges. First, a network externality leads farmers to use improved inputs only if their neighbors do. By lowering the costs of adopting  inputs for all farmers, the ISP internalizes this externality. Second, farmers with a comparative advantage in migration face credit constraints, making the upfront cost of migration unaffordable. ISPs can allow farmers to overcome their credit constraint and reap the gains of comparative advantage. I substantiate the predictions of the theoretical framework  using a panel of Zambian smallholders, many of whom benefited from an ISP. I find that ISPs have a quantitatively large effect on outmigration from beneficiary areas.  
    </font>
    </p>
  </details> 
